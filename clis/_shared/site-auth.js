import { AuthRequiredError, TimeoutError, getErrorMessage } from '@yangshengzhou/leafcli/errors';
...
function authHint(config) {
  return `Run \`leafcli ${config.site} login\` to open the login page, then retry.`;
}
