/**
 * Plugin lifecycle hooks: allows plugins to tap into leafcli's execution lifecycle.
 *
...
declare global {
  ...
  var __leafcli_hooks__: Map<HookName, HookFn[]> | undefined;
}
const _hooks: Map<HookName, HookFn[]> =
  globalThis.__leafcli_hooks__ ??= new Map();
...
// ── Emit API (used internally by leafcli core) ─────────────────────────────
