...
export const setupCommand = cli({
  ...
  name: 'setup',
  access: 'read',
  description: 'Show local setup commands for controlling Trae CN with leafcli',
  example: 'leafcli trae-cn setup -f table',
  ...
  func: async () => [
    ...
    },
    {
      ...
      Purpose: 'Trae CN may still stop these as high-risk even when command mode is 自动运行; leafcli approves them only after explicit --auto-approve true or approve',
    },
    {
      Step: 'Help',
      Command: 'leafcli trae-cn --help -f yaml',
