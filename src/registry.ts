...
declare global { var __leafcli_registry__: Map<string, CliCommand> | undefined; }
const _registry: Map<string, CliCommand> =
  globalThis.__leafcli_registry__ ??= new Map<string, CliCommand>();
 ...
 *
 * `strategy` itself is preserved as metadata for `leafcli list`, cascade
