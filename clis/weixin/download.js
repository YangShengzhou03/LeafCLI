 ...
 *
 * Ported from yangshengzhou/wechat-article-to-markdown (JS version) to leafcli adapter.
 *
 * Usage:
 *   leafcli weixin download --url "https://mp.weixin.qq.com/s/xxx" --output ./weixin
 */
