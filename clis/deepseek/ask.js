...
import { CliError, CommandExecutionError, EXIT_CODES, TimeoutError } from '@yangshengzhou/leafcli/errors';
import {
...
export const askCommand = cli({
    ...
    func: async (page, kwargs) => {
        ...
        const modelExplicit = kwargs.__leafcliOptionSources?.model === 'cli';
