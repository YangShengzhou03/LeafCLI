...
import { CliError, CommandExecutionError, ConfigError, EXIT_CODES, getErrorMessage } from '@yangshengzhou/leafcli/errors';
...
export function getXiaoyuzhouCredentialFile() {
    return path.join(os.homedir(), '.leafcli', 'xiaoyuzhou.json');
}
