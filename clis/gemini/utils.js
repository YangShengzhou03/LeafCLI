...
const GEMINI_COMPOSER_MARKER_ATTR = 'data-leafcli-gemini-composer';
...
function exportGeminiDeepResearchReportScript(maxWaitMs) {
    ...
    (async () => {
      ...
      const recorderKey = '__leafcliGeminiExportUrls';
      const patchedKey = '__leafcliGeminiExportPatched';
      const trace = [];
      ...
      const ensureRecorder = () => {
        ...
        XMLHttpRequest.prototype.open = function(method, url, ...rest) {
          ...
          try { this.__leafcliReqUrl = String(url || ''); } catch {}
          ...
          try {
            this.addEventListener('load', () => {
              try {
                ...
                const reqUrl = String(this.__leafcliReqUrl || '');
                if (isDriveDocCreateRequest(reqUrl)) {
