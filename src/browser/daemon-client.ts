/**
 * HTTP client for communicating with the leafcli daemon.
 *
...
export interface DaemonCommand {
  ...
  frameIndex?: number;
  /** Browser profile/context REQUIRED for this command (--profile / leafcli_PROFILE). Fails loud when offline. */
  contextId?: string;
  /**
...
async function sendCommandRaw(
  ...
  const rawWindowMode = process.env.leafcli_WINDOW;
