...
import { CommandExecutionError, selectorError } from '@yangshengzhou/leafcli/errors';
...
export const newCommand = cli({
  ...
  example: 'leafcli_CDP_ENDPOINT=http://127.0.0.1:39240 leafcli_CDP_TARGET=talk leafcli trae-cn new "请执行你的任务" -f json',
  domain: 'localhost',
